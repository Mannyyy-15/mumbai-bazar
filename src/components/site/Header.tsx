...
const MEGA_CATEGORIES: MegaMenu[] = [
    ...
    groups: [
      {
        ...
        items: [
          ...
          { label: "Latest Banarasi Silk Drops", to: "/shop?weave=banarasi" },
          { label: "Fresh Kanjivaram Bridal", to: "/shop?weave=kanjivaram" },
          { label: "Celebrity & Party Edits", to: "/shop?type=festive-party" },
        ],
      },
      {
        title: "Shop By Price",
        items: [
          { label: "Under ₹1,000 Sarees", to: "/shop?price=u1k" },
          { label: "₹1,000 – ₹3,000 Festive Woven", to: "/shop?price=1k-3k" },
          { label: "₹3,000 – ₹5,000 Bridal & Silk", to: "/shop?price=3k-5k" },
          { label: "View All Sarees", to: "/shop" },
        ],
      },
    ],
    featured: {
  ...
  },
  {
    ...
    groups: [
      {
        title: "1-Minute Everyday Sarees",
        items: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Festive Cocktail Wear", to: "/shop?type=festive-party" },
          { label: "Art Silk & Georgette", to: "/shop?q=art+silk" },
          { label: "Browse All Ready-to-Wear", to: "/everyday-sarees" },
        ],
      },
    ],
    featured: {
    ...
    groups: [
      {
        ...
        items: [
          { label: "Bridal Crimson & Red", to: "/shop?color=red-crimson&type=wedding-bridal" },
          { label: "Royal Reception Statements", to: "/wedding-sarees" },
          { label: "Sangeet & Cocktail Silks", to: "/shop?type=festive-party" },
          { label: "Haldi & Mehendi Yellows", to: "/shop?color=gold-yellow&type=wedding-bridal" },
        ],
      },
      {
        title: "Trousseau & Heritage",
        items: [
          { label: "Interactive Trousseau Builder", to: "/trousseau-builder" },
          { label: "Emerald Green & Teal", to: "/shop?color=green-emerald&type=wedding-bridal" },
          { label: "Ornate Zari Butti Sarees", to: "/shop?q=zari" },
    ...
    groups: [
      {
        title: "Iconic Weaves",
        items: [
          { label: "Pure Banarasi Silk", to: "/shop?weave=banarasi" },
          { label: "Kanjivaram Temple Borders", to: "/shop?weave=kanjivaram" },
          { label: "Paithani & Maharashtra Weaves", to: "/shop?weave=paithani" },
          { label: "Temple Border Silks", to: "/shop?q=temple" },
        ],
      },
      {
        title: "Artisan Collections",
        items: [
          { label: "Zari Butti Heritage Drapes", to: "/shop?q=zari" },
          { label: "Maheshwari & Gadwal Weaves", to: "/shop?q=maheshwari" },
          { label: "Explore All Heritage Silks", to: "/silk-sarees" },
    ...
    groups: [
      {
        ...
        items: [
          { label: "Diwali & Puja Silks", to: "/festive-edit" },
          { label: "Bandhani & Embellished Borders", to: "/shop?q=bandhani" },
          { label: "Zari & Brocade Drapes", to: "/shop?q=zari" },
          { label: "Evening Gala & Reception", to: "/festive-edit" },
        ],
      },
      {
        title: "Jewel Shades",
        items: [
          { label: "Ruby Red & Maroon", to: "/shop?color=red-crimson" },
          { label: "Peacock Blue & Navy", to: "/shop?color=blue-peacock" },
          { label: "Emerald Green & Olive", to: "/shop?color=green-emerald" },
...
const MOBILE_NAV_ITEMS: MobileNavItem[] = [
  ...
  { label: "Collections", to: "/collections" },
  { label: "Trousseau Builder", to: "/trousseau-builder" },
  { label: "Our Story", to: "/our-story" },

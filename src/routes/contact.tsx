...
import { Mail, Phone, MessageCircle, MapPin, Clock, Send, CheckCircle2, ChevronDown } from "lucide-react";

export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact Us & Concierge — Mumbai Bazar" },
      { name: "description", content: "Speak to a saree expert on WhatsApp, email, or visit our Mumbai flagship boutique." },
      { property: "og:title", content: "Contact Us & Concierge — Mumbai Bazar" },
      { property: "og:description", content: "We're here to help you find the perfect saree." },
    ],
  }),
  component: ContactPage,
});

const WA_HREF = "https://wa.me/919999999999?text=" + encodeURIComponent("Hello Mumbai Bazar, I'd like to speak to a saree expert.");

const FAQS = [
  { q: "Can I get custom blouse stitching or color matching?", a: "Yes! Our concierge team offers custom unstitched blouse material pairing, lining advice, and direct weaver color customization for bridal orders." },
  { q: "How long does shipping take across India?", a: "Orders are dispatched within 24–48 hours via insured express courier. Standard delivery takes 3–5 business days across major Indian cities." },
      ...
      <section className="relative border-b border-gold/30 bg-beige/25">
        <div className="w-full px-4 md:px-8 lg:px-12 xl:px-16 py-12 md:py-16">
          ...
          <div className="max-w-3xl">
            ...
            <h1 className="font-serif text-4xl leading-tight text-maroon md:text-6xl">We're Here for You</h1>
            <p className="mt-3 text-sm md:text-base text-maroon/80 leading-relaxed">
              Whether you need help selecting a bridal heirloom, custom color dyeing, or order updates — our saree consultants are at your service.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              <div>
                ...
                <p className="mt-2 text-sm text-ink/80 leading-relaxed">Fastest way to reach our stylists for live saree drape photos & videos. Replies in &lt;1 hour.</p>
              </div>
              <p className="mt-6 text-xs uppercase tracking-[0.25em] text-maroon font-semibold group-hover:text-gold transition-colors">Chat on WhatsApp →</p>
            </a>
            ...
            >
              <div>
                ...
                <p className="mt-2 text-sm text-ink/80 leading-relaxed">care@mumbaiBazar.in · For order inquiries, custom weaving requests & press.</p>
              </div>
              <p className="mt-6 text-xs uppercase tracking-[0.25em] text-maroon font-semibold group-hover:text-gold transition-colors">Send an Email →</p>
            </a>
            ...
            >
              <div>
                ...
                <p className="mt-2 text-sm text-ink/80 leading-relaxed">+91 98200 00000 · Mon–Sat · 10:00 AM – 8:00 PM IST.</p>
              </div>
              <p className="mt-6 text-xs uppercase tracking-[0.25em] text-maroon font-semibold group-hover:text-gold transition-colors">Call Boutique Direct →</p>
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="w-full px-4 md:px-8 lg:px-12 xl:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-7 bg-ivory rounded-3xl p-8 md:p-12 border border-gold/50 shadow-xl">
              <span className="text-[10px] uppercase tracking-[0.3em] text-gold font-medium">Send a Message</span>
              <h2 className="font-serif text-3xl md:text-4xl text-maroon mt-2">Write to Our Saree Stylists</h2>
              ...
              {sent ? (
                <div className="mt-8 rounded-2xl border border-maroon/40 bg-maroon/5 p-6 text-maroon flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-maroon/80 mt-1">Thank you. A senior saree consultant will respond within 2–4 hours.</p>
                  </div>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-xs uppercase tracking-widest text-maroon font-medium mb-2">Your Name</label>
                      <input
                        type="text"
                        required
                    ...
                    <div>
                      <label className="block text-xs uppercase tracking-widest text-maroon font-medium mb-2">Email Address</label>
                      <input
                        type="email"
                        required
                  ...
                  <div>
                    <label className="block text-xs uppercase tracking-widest text-maroon font-medium mb-2">Inquiry Type</label>
                    <select
                      value={form.topic}
                  ...
                  <div>
                    <label className="block text-xs uppercase tracking-widest text-maroon font-medium mb-2">How can we help?</label>
                    <textarea
                      required
                      rows={4}
              ...
              <div className="bg-ivory rounded-3xl p-8 border border-gold/50 shadow-md">
                ...
                <div className="space-y-4 text-sm text-ink/80">
                  <div className="flex items-start gap-3">
                    ...
                    <p>Mumbai Bazar Boutique Studio<br />Marine Drive & Churchgate Promenade, Mumbai, India</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <Clock className="h-5 w-5 text-gold shrink-0 mt-0.5" />
                    <p>Monday – Saturday: 10:00 AM – 8:00 PM IST<br />Sunday: By Private Appointment</p>
                  </div>
                </div>
              </div>

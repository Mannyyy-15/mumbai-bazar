...
const CURATED_CARDS = [
  {
    ...
    eyebrow: "Collection",
    title: "Bridal Sarees",
    desc: "Red Banarasi, gold Kanjivaram and crimson zari butti sarees for weddings and receptions.",
    to: "/wedding-sarees",
    img: IMG.colWedding,
  ...
  },
  {
    ...
    title: "Trousseau Builder",
    desc: "Curate a 3-saree bridal bundle with personal styling and 15% custom bundle savings.",
    to: "/trousseau-builder",
    img: IMG.look1,
    badge: "3-Saree Keepsake",
    bgClass: "bg-[#FDF6F0] hover:bg-[#F9ECE0] border-[#EAD5C5]",
    textClass: "text-[#58111A]",
  },
  {
    id: "banarasi",
    category: "artisan",
    eyebrow: "Collection",
    title: "Banarasi & Heritage Silks",
    desc: "Gold zari brocade, Katan silk, and authentic Kanjivaram master-artisan drapes.",
    to: "/silk-sarees",
    img: IMG.colBanarasi,
    badge: "Woven Brocade",
  ...
  },
  {
    id: "temple-border",
    category: "artisan",
    eyebrow: "Artisan Weave",
    title: "Temple Border Silks",
    desc: "Classic temple borders and floral zari butti contrast drapes across vibrant jewel shades.",
    to: "/shop?q=temple",
    img: IMG.p3,
    badge: "Temple Borders",
    bgClass: "bg-[#F3F7F2] hover:bg-[#E8EFE6] border-[#D1E0CE]",
    textClass: "text-[#1B4D2E]",
  },
  {
    id: "festive",
    category: "festive",
    eyebrow: "Collection",
    title: "Festive Edit",
    desc: "Bright colours, embellished borders and shiny zari tissue sarees for pujas and celebrations.",
    to: "/festive-edit",
    img: IMG.colFestive,
  ...
  },
  {
    ...
    title: "Bandhani & Printed Zari",
    desc: "Festive Bandhani prints and intricate embellished borders for Diwali, Karwa Chauth and pujas.",
    to: "/shop?q=bandhani",
    img: IMG.p4,
    badge: "Festive Prints",
    bgClass: "bg-[#FFF8EE] hover:bg-[#FFF0DC] border-[#F5DEC0]",
    textClass: "text-[#7A3E08]",
  },
  {
    id: "ready-to-wear",
    category: "everyday",
    eyebrow: "Collection",
    title: "Ready to Wear",
    desc: "Pre-pleated, lightweight daily silks with zero draping hassle for office and family wear.",
    to: "/everyday-sarees",
    img: IMG.colPuresilk,
    badge: "1-Minute Drapes",
  ...
  },
  {
    ...
    category: "everyday",
    eyebrow: "Daily Drape",
    title: "Cotton Silk & Kalamkari",
    desc: "Breathable cotton blends, Gadwal cotton, and Kalamkari handblock prints for everyday comfort.",
    to: "/shop?fabric=cotton-silk",
    img: IMG.p2,
    badge: "Breathable Weaves",
    bgClass: "bg-[#F4F6F8] hover:bg-[#E9EDF2] border-[#D3DBE4]",
    textClass: "text-[#1C3B57]",
  },
  {
    id: "budget-boutique",
    category: "everyday",
    eyebrow: "Curated Price",
    title: "Under ₹1,000 Everyday",
    desc: "Budget-friendly daily sarees under ₹1,000 delivered directly from our Mumbai store.",
    to: "/shop?price=u1k",
    img: IMG.look2,
    badge: "Under ₹1,000",
    bgClass: "bg-[#FDFBF7] hover:bg-[#F7F2EA] border-[#EBE4D5]",
    textClass: "text-[#3D3325]",
  },
  {
    id: "new-arrivals",
    category: "all",
    eyebrow: "Collection",
    title: "New Arrivals",
    desc: "Fresh arrivals and newly listed boutique designs added every week.",
    to: "/new-arrivals",
  ...
  },
  {
    ...
    eyebrow: "Collection",
    title: "All Products",
    desc: "See every saree we stock — filter by occasion, weave, price and colour.",
    to: "/shop",
    img: IMG.craft,
    badge: "All Sarees",

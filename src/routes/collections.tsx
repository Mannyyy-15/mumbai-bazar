...
const CURATED_CARDS = [
  {
    ...
    eyebrow: "Collection",
    title: "Bridal Sarees",
    desc: "Red Banarasi and gold Kanjivaram sarees for the wedding day and reception.",
    to: "/wedding-sarees",
    img: IMG.colWedding,
  ...
  },
  {
    ...
    eyebrow: "Collection",
    title: "Banarasi Silk",
    desc: "Gold zari work on rich brocade — the classic wedding and reception saree.",
    to: "/silk-sarees",
    img: IMG.colBanarasi,
    badge: "Woven Brocade",
  ...
  },
  {
    ...
    eyebrow: "Collection",
    title: "Festive Edit",
    desc: "Bright colours and shiny zari tissue sarees for pujas, parties and festivals.",
    to: "/festive-edit",
    img: IMG.colFestive,
  ...
  },
  {
    ...
    eyebrow: "Collection",
    title: "Ready to Wear",
    desc: "Light, breathable silks that are easy to wear every day and to office.",
    to: "/everyday-sarees",
    img: IMG.colPuresilk,
    badge: "Lightweight Sarees",
  ...
  },
  {
    ...
    eyebrow: "Collection",
    title: "New Arrivals",
    desc: "Fresh stock, just arrived. New designs added every week.",
    to: "/new-arrivals",
  ...
  },
  {
    ...
    eyebrow: "Collection",
    title: "All Products",
    desc: "See every saree we stock — filter by occasion, price and colour.",
    to: "/shop",
    img: IMG.craft,
    badge: "All Sarees",

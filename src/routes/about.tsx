...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About Us — Mumbai Bazar" },
      { name: "description", content: "Meet Mumbai Bazar — a modern saree boutique built on heirloom weaves, honest fabric and personal styling." },
      { property: "og:title", content: "About Us — Mumbai Bazar" },
      { property: "og:description", content: "The people, the weavers and the philosophy behind every drape." },
    ],
  }),
  component: About,
});
...
const VALUES = [
  { icon: Heart, title: "Human hands", copy: "Every piece is handwoven — no power looms, no shortcuts." },
  { icon: Award, title: "Silk Mark verified", copy: "Independently tested silks and real zari, always disclosed." },
  { icon: MapPin, title: "Rooted in India", copy: "Direct-from-cluster sourcing across seven weaving regions." },
];
    ...
    <>
      ...
      <section className="bg-ivory py-16 md:py-24">
        <div className="mx-auto max-w-[1200px] px-4 md:px-8">
          <div className="text-center">
            ...
            <div className="mt-4 flex justify-center"><GoldRule /></div>
          </div>
      ...
      <section className="bg-beige/40 py-20 md:py-28">
        <div className="mx-auto grid max-w-[1360px] grid-cols-1 items-center gap-12 px-4 md:grid-cols-12 md:gap-16 md:px-8">
          <div className="md:col-span-6">
            <img src={IMG.look3} alt="Draping session at the boutique" className="w-full object-cover aspect-[4/5]" />
          </div>
          <div className="md:col-span-6">
            ...
            <p className="mt-4 text-taupe leading-relaxed">
              ...
              wages, funding tools and looms, and never pushing a design deadline that would compromise
              the weave.
            </p>
      ...
      <section className="bg-ivory py-20 md:py-28">
        <div className="mx-auto max-w-[1000px] px-4 md:px-8">
          <div className="text-center">
            ...
            <h2 className="mt-3 font-serif text-3xl md:text-5xl text-ink">Ten years, one loom at a time.</h2>
          </div>
          <ol className="mt-14 space-y-8">
            {MILESTONES.map(([year, note]) => (
              <li key={year} className="grid grid-cols-[80px_1fr] items-start gap-6 border-b border-gold/50 pb-6 md:grid-cols-[120px_1fr]">
      ...
      <section className="bg-wine text-ivory py-20 md:py-24">
        <div className="mx-auto max-w-[900px] px-4 md:px-8 text-center">
          <span className="text-[11px] tracking-[0.28em] uppercase text-gold">Visit the boutique</span>
          <h2 className="mt-4 font-serif text-3xl md:text-5xl">
            Come drape a saree with us.
          </h2>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            ...
            <Link to="/collections" className="link-gold">Explore Collections <ArrowRight className="h-4 w-4" /></Link>
          </div>
        </div>
      </section>
    </>
